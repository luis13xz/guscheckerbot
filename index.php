...
$botToken = "1701083725:AAGhRLZt6W9s4ZYtAKlR0XOuE8Co90Bobwc"; // Enter ur bot token
...
sendMessage($chatId, "<b>Hola!!%0AType /cmds Para Lista de Comandos !!%0A%0ABot Hecho Por Gus  </b>");
}

//////////=========[Cmds Command]=========//////////

elseif ((strpos($message, "!cmds") === 0)||(strpos($message, "/cmds") === 0)){
sendMessage($chatId, "<u>Buscar Bin:</u> <code>!bin</code> xxxxxx%0A<u>SK Key Check:</u> <code>!sk</code> sk_live%0A<u> Para Conocer Tu informacion%0A%0A<b>Bot Hecho Por Gus  </b>");
}

//////////=========[Info Command]=========//////////

elseif ((strpos($message, "!info") === 0)||(strpos($message, "/info") === 0)){
sendMessage($chatId, "<u>ID:</u> <code>$userId</code>%0A<u>First Name:</u> $firstname%0A<u>Username:</u> @$username%0A%0A<b>Bot Hecho Por Gus   </b>");
}
...
curl_close($ch);
sendMessage($chatId, '<b>✅ Bin valido</b>%0A<b>Banco:</b> '.$bank.'%0A<b>Country:</b> '.$name.''.$emoji.'%0A<b>Marca:</b> '.$brand.'%0A<b>Card:</b> '.$scheme.'%0A<b>Tipo:</b> '.$type.'%0A<b>Divisa:</b> '.$currency.'%0A<b>Comprobado Por:</b> @'.$username.'%0A%0A<b>Bot Hecho Por Gus  </b>');
}
curl_close($ch);
...
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>IP:</u> <b>'.$ip.'</b>%0A<u>ESTADO:</u> <b>APROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ CVV MATCHED ★ 』</b>%0A<u>Bank:</u> '.$bank1.'%0A<u>Country:</u> '.$name1.'%0A<u>Brand:</u> '.$brand.'%0A<u>Card:</u> '.$scheme.'%0A<u>Type:</u> '.$type.'%0A<u>Gate:</u> <b>Stripe</b>%0A<u>Comprobado Por:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus  </b>');
}
...
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>IP:</u> <b>'.$ip.'</b>%0A<u>ESTADO:</u> <b>REPROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ Declined : Generic_Decline ★ 』</b>%0A<u>Bank:</u> '.$bank1.'%0A<u>Country:</u> '.$name1.'%0A<u>Brand:</u> '.$brand.'%0A<u>Card:</u> '.$scheme.'%0A<u>Type:</u> '.$type.'%0A<u>Gateway:</u> <b>Stripe</b>%0A<u>Comprobado Por:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus </b>');
}
...
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>ESTADO:</u> <b>APROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ CVV MATCHED [M][U] ★ 』 %0A<u>Chargeable::</u> <b>『 ★  Maybe Yes ★ 』</b>%0A</b><u>Gate:</u> <b>Convergepay</b>%0A<u>Comprobado Por :</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus </b>');
}
elseif($cvvres == "M"){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>ESTADO:</u> <b>APROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ CVV MATCHED [M]['.$avsres.'] ★ 』 %0A<u>Chargeable::</u> <b>『 ★ Chargeable: '.$chStatus.' ★ 』</b>%0A</b><u>Gateway:</u> <b>Convergepay</b>%0A<u>Comprobado Por:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus </b>');
}
elseif($cvvres == "N"){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>ESTADO:</u> <b>APROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ LIVE CCN [N]['.$avsres.'] ★ 』%0A<u>Chargeable::</u> <b>『 ★ No ★ 』</b>%0A</b><u>Gate:</u> <b>Convergepay</b>%0A<u>Comprobado Por:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus </b>');
}
elseif (strpos($result9, '"success":true')){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>ESTADO:</u> <b>APROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ Charged CVV ★ 』%0A<u>Chargeable::</u> <b>『 ★ Yes ★ 』</b>%0A</b><u>Gate:</u> <b>Convergepay</b>%0A<u>Comprobado Por:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus </b>');
}
elseif(!$result9){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>ESTADO:</u> <b>REPROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ Unknown Error ★ 』</b><u>Gate:</u> <b>Convergepay</b>%0A<u>:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus </b>');
}else{
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>ESTADO:</u> <b>REPROVADA</b>%0A<u>RESPONSE:</u> <b>『 ★ Card Declined ['.$cvvres.']['.$avsres.'] ★ 』%0A<u>Mensaje::</u> <b>『 ★ Msg: '.$msg.' ★ 』[Maybe api dead]</b>%0A</b><u>Gateway:</u> <b>Convergepay</b>%0A<u>Comprobado Por:</u> @'.$username.'<u>%0ATiempo:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Hecho Por Gus</b>');
}
curl_close($ch);
}
...
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> EXPIRED KEY%0A%0A<b>Bot Hecho Por Gus </b>");
}
elseif (strpos($result, 'Invalid API Key provided')){
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> INVALID KEY%0A%0A<b>Bot Hecho Por Gus </b>");
}
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> Testmode Charges Only%0A%0A<b>Bot Hecho Por Gus  </b>");
}else{
sendMessage($chatId, "<b>✅ LIVE KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>RESPONSE:</u> SK LIVE!!%0A%0A<b>Bot Hecho Por Gus  </b>");
}}
